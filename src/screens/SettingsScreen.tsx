import { Download, RefreshCw, RotateCcw, ShieldCheck, Sparkles, Undo2, Upload } from 'lucide-react';
import { useEffect, useRef, useState } from 'react';
import { Button } from '../components/ui';
import { isAiPreconfigured } from '../services/aiSettings';
import { useStore } from '../store/StoreProvider';
import { AiUsagePanel } from '../components/AiUsagePanel';
import { compareVersions, CURRENT_VERSION, installRelease, IS_PLAY_DISTRIBUTION, latestRelease, type AppRelease } from '../services/appUpdater';
...
export function SettingsScreen() {
  const { state, reset, replaceState } = useStore();
