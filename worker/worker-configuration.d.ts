/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/worker-configuration.d.ts` (hash: 57c4a80c9b6dcd54c8b812e3d2701e4c)
// Runtime types generated with workerd@1.20260828.1 2026-09-02 nodejs_compat
interface __BaseEnv_Env {
	ANALYSIS_RATE_LIMITER: RateLimit;
	COMPARE_RATE_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_MODEL" | "OPENAI_API_KEY" | "APP_ACCESS_TOKEN">> {}
}
